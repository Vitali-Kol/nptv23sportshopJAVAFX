...
public class EquipmentListController implements Initializable {
    ...
    private final CustomerService customerService; // Добавили экземпляр CustomerService
    ...
    // Обновлённый конструктор с внедрением CustomerService
    public EquipmentListController(EquipmentService equipmentService, FormService formService, CustomerService customerService) {
    ...
    private void editSelectedEquipment() {
        // Вместо статического вызова используем инстанс customerService
