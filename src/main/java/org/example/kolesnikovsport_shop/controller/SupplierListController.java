...
public class SupplierListController implements Initializable {
    ...
    private final CustomerService customerService; // Добавляем CustomerService
    ...
    // Обновлённый конструктор с CustomerService
    ...
    private void editSelectedSupplier() {
        // Вызываем метод через внедрённый экземпляр customerService
