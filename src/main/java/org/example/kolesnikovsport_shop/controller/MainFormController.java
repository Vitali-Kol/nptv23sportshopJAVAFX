...
public class MainFormController implements Initializable {
    ...
    private final CustomerService customerService;  // добавить поле для инстанса
    ...
    public MainFormController(FormService formService, EquipmentService equipmentService, CustomerService customerService) {
    ...
    private void showEditEquipmentForm() {
        // Используем инстанс customerService вместо класса
