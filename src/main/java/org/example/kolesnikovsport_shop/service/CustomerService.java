...
public class CustomerService {
    ...
    public boolean authenticate(String username, String password) {
        ...
        this.currentCustomer = loginCustomer;
        return true;
    }

    // Instance‑методы проверки ролей
    ...
    public Customer changePassword(Long userId, String newPassword) {
        // Если текущий пользователь не администратор, он может менять пароль только для себя
