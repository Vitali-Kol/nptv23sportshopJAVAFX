...
import org.example.kolesnikovsport_shop.controller.*;
...
public class FormService {
    ...
    // Добавление метода для загрузки формы чата
    public void loadChatForm() {
        FXMLLoader fxmlLoader = springFXMLLoader.load("/chatForm.fxml");
        try {
            ...
            e.printStackTrace();
            new Alert(Alert.AlertType.ERROR, "Не удалось загрузить окно чата:\n" + e.getMessage())
                    .showAndWait();
        }
    }
}
